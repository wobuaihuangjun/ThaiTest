...
import com.xtc.libthai.segmenter.matcher.MinimumMatcher;
...
public class ThaiMinMatchSegmenter extends AbstractThaiSegmenter {
    private Matcher minMatcher;
    private POS pos;

    public ThaiMinMatchSegmenter() {
        this.minMatcher = new MinimumMatcher(ThaiCoreDictionary.thaiDictionary.dictionaryTrie);
        this.pos = new ThaiPOS();
    }

    protected List<Term> segment(String[] sentence) {
        List<Term> ret = this.minMatcher.segment(sentence);
